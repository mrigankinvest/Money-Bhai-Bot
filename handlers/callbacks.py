...
async def handle_callback(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    # Wrap all database logic in the new session context manager
    async with get_session() as session:
        ...
        if data.startswith("show_wallets_"):
            ...
            all_wallets = await db_writer.get_wallets(user_id)
        ...
        elif data.startswith("wallet_txn_report_menu_"):
        ...
        # ===================================================================
            ...
            await edit_and_log(
                query, 
                context, 
                text="This button's action is not defined or has expired."
            )
